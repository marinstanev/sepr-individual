...
public class HorseEndpointTest extends TestBase {
  ...
  @Test
  public void creatingHorseWithValidDataReturns201() throws Exception {
    HorseDetailDto horse = new HorseDetailDto(1L, "Test Horse", Sex.MALE, LocalDate.of(2000, 1, 1), 5, 10, null);
    String requestBody = objectMapper.writeValueAsString(horse);
  ...
  @Test
  public void gettingHorseByIdReturns200() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders
            .get("/horses/{id}", -3))
        .andExpect(status().isOk());
  }
  ...
  @Test
  public void gettingHorseWithInvalidIdReturns404() throws Exception {
    mockMvc
        .perform(MockMvcRequestBuilders
            .get("/horses/invalidId")
        ).andExpect(status().isBadRequest());
  }

  @Test
  public void deletingNonexistentHorseReturns404() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders.delete("/horses/{id}", 999)
            .contentType(MediaType.APPLICATION_JSON))
        .andExpect(status().isNotFound());
  }
}
